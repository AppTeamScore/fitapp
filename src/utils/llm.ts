...
3. Список упражнений с количеством подходов и повторений (учитывай уровень и цели)
4. Продолжительность тренировки в минутах (учитывай желаемую длительность)

Правка: Отдых не является днем тренировки или недели, его не указывай, а просто пропусти этот день! Если дней мало, сделай более интенсивные тренировки.
...
Вывод данных в JSON формат (обязательно следуй точно):
{
  ...
  "recommendations": "Общие рекомендации ко всему плану тренировок, учитывая все данные пользователя (возраст, вес, цели, ограничения и т.д.)."
}`;

  console.log('API Response Status:', 'Данные получены, обрабатываю.'); // Отладка статуса
