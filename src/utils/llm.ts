...
Доступные упражнения (строго только эти упражнения):
...
Правки:
Частота тренировок является главным показателем, для количества тренировок в неделю.
...
Адаптируй количество упражнений и время на каждое упражнение исходя из длительности тренировки.
